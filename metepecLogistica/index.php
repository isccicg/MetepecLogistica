...
if(isset($_SESSION["slm_usu"]))
{
	...
	if($_SESSION["tipoUsuario"] == 2)
	{
	   ...
	   if( $_GET['action'] == 'crearGira' ) //muestra  el modulo "crear Gira"
		{
				$userC->crearGira();	
		}
	...
	if($_SESSION["tipoUsuario"] == 1)
	{
		...
		if( $_GET['action'] == 'aprobacionGira' ) //muestra  el modulo "index Principal User Campo"
		{
		...
		{
				// $mvc->index();	
				$userS->indexUserSup();	//muestra  el modulo "index Principal User Campo"
		}
	}
}	
else
