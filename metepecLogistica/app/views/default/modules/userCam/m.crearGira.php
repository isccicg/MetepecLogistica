 ...
 <div class="box box-primary">
  ...
  <!--DATOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS-->        
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="bg-primary text-center pad-basic no-btm">AGENDA</h3>
            </div>
            <div class="box-body">
              <div class="col-md-12">
 ...
 <div class="box box-primary">
  ...
  <!--DATOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS-->   
           ...
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="bg-primary text-center pad-basic no-btm">CABILDO</h3>
            </div>
            <div class="box-body">
              <div class="col-md-12">
                <div class="col-lg-12 col-xs-12 table-responsive">
...
<!--DATOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS-->        
 <div class="box box-primary">
  ...
  <!--DATOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS-->   
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="bg-primary text-center pad-basic no-btm">PRESIDIUM</h3>
            </div>
            <div class="box-body">
              <div class="col-md-12">
                <div class="col-lg-12 col-xs-12 table-responsive">
